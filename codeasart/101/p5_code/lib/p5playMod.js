	...
	this.Sprite = class {
		...
		__draw() {
			...
			if (this.text !== undefined) {
				// this.p.textAlign(this.p.CENTER, this.textAlignY);
				...
				this.p.text(this.text, this.textAlignX || 0, this.textAlignY || 0);
			}		   
		...
		// 	 // Decide an angle
		// 	 this.textspacingAngle;
		   
		// 	 push()
		// 	 // Let's first move to the center of the circle
		// 	 translate(this.textAlignX, this.textAlignY)
		   
		// 	 // First rotate half back so that middle char will come in the center
		// 	 rotate(radians(-this.chars.length * this.textspacingAngle / 2))
		   
		// 	 for (let i = 0; i < this.chars.length; i++) {
		// 		 text(this.chars[i], 0, -this.textRadius)
		   
		// 		 // Then keep rotating forward per character
		// 		 rotate(radians(this.textspacingAngle))
		// 	 }
		// 	 pop()
